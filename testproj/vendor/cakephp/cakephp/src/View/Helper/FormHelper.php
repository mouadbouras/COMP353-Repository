...
class FormHelper extends Helper
{
    ...
    protected $_defaultConfig = [
        ...
        'templates' => [
            ...
            'input' => '<input class="form-control" placeholder="{{name}}" type="{{type}}" name="{{name}}"{{attrs}}/>',
            'inputSubmit' => '<input type="{{type}}"{{attrs}}/>',
            'inputContainer' => '<fieldset class="form-group input {{type}}{{required}}">{{content}}</fieldset>',
            'inputContainerError' => '<fieldset class="form-group input {{type}}{{required}} error">{{content}}{{error}}</fieldset>',
